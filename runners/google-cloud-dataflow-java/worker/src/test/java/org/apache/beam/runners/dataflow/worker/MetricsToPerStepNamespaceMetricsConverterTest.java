...
public class MetricsToPerStepNamespaceMetricsConverterTest {
  ...
  public void testConvert_successfulyConvertCounters() {
    ...
    Collection<PerStepNamespaceMetrics> conversionResult =
        MetricsToPerStepNamespaceMetricsConverter.convert(step, counters, emptyHistograms, parsedMetricNames);
    ...
    LabeledMetricNameUtils.ParsedMetricName parsedBigQueryMetric1 = LabeledMetricNameUtils.parseMetricName(bigQueryMetric1.getName()).get();
    LabeledMetricNameUtils.ParsedMetricName parsedBigQueryMetric2 = LabeledMetricNameUtils.parseMetricName(bigQueryMetric2.getName()).get();
  ...
  public void testConvert_skipInvalidMetricNames() {
    ...
    Collection<PerStepNamespaceMetrics> conversionResult =
        MetricsToPerStepNamespaceMetricsConverter.convert("testStep", counters, histograms, parsedMetricNames);
  ...
  public void testConvert_successfulConvertHistograms() {
    ...
    Collection<PerStepNamespaceMetrics> conversionResult =
        MetricsToPerStepNamespaceMetricsConverter.convert(step, emptyCounters, histograms, parsedMetricNames);
  ...
  public void testConvert_convertCountersAndHistograms() {
    ...
    Collection<PerStepNamespaceMetrics> conversionResult =
        MetricsToPerStepNamespaceMetricsConverter.convert(step, counters, histograms, parsedMetricNames);
    ...
    // Verify that parsedMetricNames have been cached.
    LabeledMetricNameUtils.ParsedMetricName parsedCounterMetricName = LabeledMetricNameUtils.parseMetricName(counterMetricName.getName()).get();
    LabeledMetricNameUtils.ParsedMetricName parsedHistogramMetricName = LabeledMetricNameUtils.parseMetricName(histogramMetricName.getName()).get();

    assertThat(parsedMetricNames.size(), equalTo(2));
    assertThat(parsedMetricNames, IsMapContaining.hasEntry(counterMetricName, parsedCounterMetricName));
    assertThat(parsedMetricNames, IsMapContaining.hasEntry(histogramMetricName, parsedHistogramMetricName));
  }
}
